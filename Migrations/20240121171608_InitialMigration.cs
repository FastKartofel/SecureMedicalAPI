        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, "paddy.z@example.com", "Patryk", "Zaluska" },
                    { 3, "kilic.a@example.com", "Arzu", "Kilic" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "For headache.", "Aspirin", "Normal" },
                    { 2, "For pain.", "Morphin", "Hard" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(1980, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Anastazja", "Belarus" },
                    { 2, new DateTime(1983, 12, 12, 0, 0, 0, 0, DateTimeKind.Unspecified), "Marcin", "Chęciński" },
                    { 3, new DateTime(1987, 6, 9, 0, 0, 0, 0, DateTimeKind.Unspecified), "Zuzanna", "Bielińska" }
                });
